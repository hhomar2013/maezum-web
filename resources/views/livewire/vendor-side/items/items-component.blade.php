                    ...
                    <div class="form-row">
                        <div class="form-group col">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <label for="">{{ __('Your Own Categories') }}</label>
                                    <select wire:model="section_id" class="form-control mb-2">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        <div class="col-10">
                            ...
                            @foreach ($item->variations as $variation)
                                <small><b>{{ $variation->name }} - {{ $variation->price }}</b></small><br>
                            @endforeach
                        </div>
