<div class="card">
    <div class="card-body">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <?php $i = App\Helpers\PaginationHelper::getStartingNumber($addons); ?>
                ...
                <tr>
                    ...
                    <td>
                        @livewire('switcher', ['model' => $addon, 'field' => 'status'], key("cat-".$addon->id))
                    </td>
                    <td>
                        <button class="btn btn-success btn-rounded" wire:click="edit({{ $addon->id }})" >
